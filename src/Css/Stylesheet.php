...
class Stylesheet
{
     ...
     * @var string
     */
    const PATTERN_CSS_URL = '(?<CSS_URL>url\(\s*(?<CSS_URL_QUOTE>[\'"]?)(?<CSS_URL_VALUE>.*?)(?(CSS_URL_QUOTE)(?<!\\\\)\g{CSS_URL_QUOTE})\s*\))';
    ...
    private function _parse_css($str)
    {
        ...
        $pattern_css_url = self::PATTERN_CSS_URL;
        ...
        $re = <<<EOL
            /
                ...
                (?<CSS_ATRULE>
                    ...
                    (?<CSS_ATRULE_RULE>
                        {{$pattern_css_url}}(?<CSS_ATRULE_URL_MEDIA_QUERY>.*?)
                        |
                        {{$pattern_media_query}}
                        |
                        [^{;]*
...
EOL;
    ...
    {
        static $pattern = "/(?<CSS_IMPORT_URL>" . self::PATTERN_CSS_URL . "|" . self::PATTERN_CSS_STRING . ")(?<CSS_IMPORT_MEDIA_QUERY>.*)/isx";
        ...
        $accept = true;
        $media_queries = preg_split("/\s*,\s*/", mb_strtolower(trim($match["CSS_IMPORT_MEDIA_QUERY"])));
